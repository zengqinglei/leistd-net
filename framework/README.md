...
# 本地打包（输出 framework/artifacts/，每个项目产出内嵌 PDB 的 .nupkg）
...
| 版本机制 | 版本基准在仓库根 `VERSION`，CI 按 Conventional Commits 推算 | [版本与发布](docs/versioning.md) |
| 消费 / 联调 | 模板默认 NuGet 引用；本地联调用本地 feed | [文档首页](docs/README.md) |
