...
/// {
///     public ValueTask HandleAsync(ResourceAuthorizationContext&lt;Order&gt; context, CancellationToken ct)
///     {
///         if (context.Resource.Status == OrderStatus.Archived) context.Deny();   // 任一拒绝即拒绝
///         else if (context.Resource.OwnerId == context.Subject.UserId) context.Allow();
///         return ValueTask.CompletedTask;   // 不给结论就什么都不调用
///     }
/// }
/// </code>
/// </example>
