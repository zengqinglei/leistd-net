...
public static class DependencyInjection
{
    ...
    /// {
    ///     [Get("/api/users/{id}")] Task&lt;Result&lt;UserDto&gt;&gt; GetAsync(Guid id);
    /// }
    /// </code>
    /// </example>
    ...
    /// </summary>
    /// <remarks>
    /// 行为与 <see cref="AddRefitServiceClient{TApi,TOptions}(IServiceCollection,string,IConfiguration,RefitSettings?)"/> 相同。
    /// </remarks>
