...
/// </remarks>
public class ClaimsSignalRUserIdProvider(IOptions<HubIdentityOptions> options) : IUserIdProvider
{
    private readonly HubIdentityOptions _options = options.Value;
