...
/// 注意：参数使用 object 而非 EntityEntry 以避免本组件依赖 EF Core，
/// EF Core 适配层（Leistd.Auditing.EntityFrameworkCore）会传入 EntityEntry。
/// </remarks>
public interface IAuditPropertySetter
{
    ...
    /// 设置创建相关的审计属性
    /// </summary>
    /// <param name="entityEntry">实体或实体变更追踪条目（EF 适配层会传入 EntityEntry）</param>
