...
public class ValidationErrorDetailsTests
{
    ...
    {
        // ProblemDetails 默认以 camelCase 序列化：无需 JsonPropertyName 即得 detail/pointer/code/localizationKey；
        ...
        Assert.Contains("\"pointer\":", withCode);
        ...
        Assert.Contains("\"pointer\":", noCode);
    }
